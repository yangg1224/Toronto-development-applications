...
Then, the result is shown in the Figure.  (Figure1 \@ref(fig:graph))
...
As mentioned in the introduction, smart investor usually hold a long term view towards the property they invest. For those in progress development applications, although they have not finished yet, they might have a positive impact in the future. So based on this idea, I sort out all the in progress applications by street name, and the result is shown in the Figure2. (Figure2 \@ref(fig:graph2))
```{r graph2,fig.cap="in process apps", echo = FALSE,fig.width=10, fig.height=4}
